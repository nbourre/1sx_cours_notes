...
??? example "Afficher le code de l'exemple"
...
??? example "Cliquez ici pour afficher l'exemple"
...
??? example "Cliquer pour voir le code de l'exemple"
...
- La classe [MeRGBLed](https://github.com/nbourre/Makeblock-Libraries/blob/master/src/MeRGBLed.h){target="_blank"}
- L'exemple [MeAurigaOnBoardLEDRing](https://github.com/nbourre/Makeblock-Libraries/blob/master/examples/Me_RGBLed/MeAurigaOnBoardLEDRing/MeAurigaOnBoardLEDRing.ino){target="_blank"}


## Encodeurs

- [LOCODuino - les interruptions](https://www.locoduino.org/spip.php?article64){target="_blank"}
- [Incremental Encoder - How it works](https://www.youtube.com/watch?v=zzHcsJDV3_o){target="_blank"}
- [How Rotary Encoder Works and Interface It with Arduino](https://lastminuteengineers.com/rotary-encoder-arduino-tutorial/){target="_blank"}
- [`attachInterrupt`](https://docs.arduino.cc/language-reference/en/functions/external-interrupts/attachInterrupt/){target="_blank"}
- [Démontage du motoréducteur MakeBlock](https://www.youtube.com/watch?v=oy374XhbXVg){target="_blank"}
- [DC motor position control using PID](https://www.youtube.com/watch?v=jTIRUXJKMX4){target="_blank"}
